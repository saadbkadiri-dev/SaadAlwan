    ...
    $(document).ready(function(){
    	setTimeout(function(){
    		$("#post-slider").owlCarousel({
	            ...
	            dots:false,
	            autoHeight: true,
	            themeClass: "owl-gallery slideshow_2"
		    });
		    $('div[id*="twitter-"] > .widget_twitter').owlCarousel({
		        items:1,
		        autoplay:false,
		        nav:false,
		        navRewind:false,
